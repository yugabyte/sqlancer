...
public class YSQLJSONBFunction implements YSQLExpression {
    ...
    public enum JSONBFunction {
        ...
        TO_JSON("to_json", 1, YSQLDataType.JSON), TO_JSONB("to_jsonb", 1, YSQLDataType.JSONB),
        ...
        // Type checking
        JSON_TYPEOF("json_typeof", 1, YSQLDataType.TEXT), JSONB_TYPEOF("jsonb_typeof", 1, YSQLDataType.TEXT),
        ...
        // Aggregate functions
        JSON_AGG("json_agg", 1, YSQLDataType.JSON), JSONB_AGG("jsonb_agg", 1, YSQLDataType.JSONB),
        ...
        public boolean isAggregate() {
            return this == JSON_AGG || this == JSONB_AGG || this == JSON_OBJECT_AGG || this == JSONB_OBJECT_AGG;
        }
