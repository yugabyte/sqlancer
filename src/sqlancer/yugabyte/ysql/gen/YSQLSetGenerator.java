...
public final class YSQLSetGenerator {
    ...
    private enum ConfigurationOption {
        ...
        APPLICATION_NAME("application_name",
                (r) -> Randomly.fromOptions("'app1'", "'app2'", "'test_client'", "''")),
        CLIENT_ENCODING("client_encoding",
                (r) -> Randomly.fromOptions("'UTF8'", "'LATIN1'", "'SQL_ASCII'")),
        // Security
        ...
        STATEMENT_TIMEOUT("statement_timeout",
                (r) -> Randomly.fromOptions(0, 1000, 5000, 30000)),
        LOCK_TIMEOUT("lock_timeout",
                (r) -> Randomly.fromOptions(0, 1000, 5000, 10000)),
        IDLE_IN_TRANSACTION_SESSION_TIMEOUT("idle_in_transaction_session_timeout",
                (r) -> Randomly.fromOptions(0, 10000, 60000)),
        IDLE_SESSION_TIMEOUT("idle_session_timeout",
                (r) -> Randomly.fromOptions(0, 60000, 300000)),
        // YugabyteDB Critical
        ...
        CURSOR_TUPLE_FRACTION("cursor_tuple_fraction",
                (r) -> Randomly.fromOptions(0.0, 0.1, 0.5, 1.0)),
        ...
        DEFAULT_TABLE_ACCESS_METHOD("default_table_access_method",
                (r) -> Randomly.fromOptions("'heap'", "'ybheap'")),
